<template>
  <section class="content">
    <div class="header-details">
      ...
      <div class="details">
        <div class="title">доверенности:</div>
        <div class="desctiption">{{ contract?.number }}</div>
        <div class="desctiption">{{ contract?.client }}</div>
        <div class="desctiption">{{ contract?.status }}</div>
        <div class="desctiption">{{ contract?.ds }}</div>
      </div>
    </div>
    <BasicWrapper>
...
export default {
  ...
  methods: {
    ...
    getByContractId() {
      AffairsApi.getByDocumentId(this.$route.params.id).then((response) => {
        if (response) {
